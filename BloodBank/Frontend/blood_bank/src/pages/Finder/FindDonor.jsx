...
const FindDonor = () => {
  ...
  return (
    <div>
      ...
      {
        donorList.length !== 0 ? (<div className='grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-4'>
          {
            donorList.map(item =>

              <div className='flex justify-center p-[20px]'>
                <div className='xl:w-[500px] lg:w-[500px] md:w-[500px] h-[300px] border-2 bg-slate-200 sm:w-[00px] '>
                  <div className='flex justify-around  '>
                    ...
                    <div className='w-[200px] h-[200px] mt-[40px]  ' >
                      <div>
                        ...
                        <i class="fa-solid fa-phone"></i><span key='2' className='cardData'>{item.mobile}</span>
                        <i class="fa-solid fa-location-dot"></i><span key='3' className='cardData'>{item.district} , {item.province}.</span>

                        <i class="fa-regular fa-calendar"></i><span key='5' className='cardData'>Last Donation : {item.lastdonationdate}</span>
                      </div>
                  ...
                  <div className='grid grid-cols-2'>
                    <div>
                      <Stack direction="row" spacing={2}>
                        <Button variant="outlined" color="error" className='w-full'>Send Request</Button>
                      </Stack>
                    </div>
                    <div>
                      <Stack direction="row" spacing={2}>
                        <Button variant="outlined" color="error" className='w-full'>Send Email</Button>
                      </Stack>
                    </div>
                  </div>
                </div>
          ...
          <div className='flex justify-center w-full/2 h-[500px] items-center bg-slate-200 m-[20px] homepara'>No Avilable Donor/Not Select All Feilds</div>
        </>)
